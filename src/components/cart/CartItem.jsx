      ...
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          ...
          transition-all duration-75 ease-in-out grid items-center`}>
            ...
            <div className="absolute right-1 top-1 blur-theme-effect bg-white/80 text-black
            text-xs px-1 rounded">${price}</div>
          </div>
          <div className="grid items-center gap-4">
            ...
            <div className="flex justify-around w-full">
              <button type="button" className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90 cursor-pointer"
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            ...
            justify-items-center cursor-pointer" onClick={onRemoveItem}>
              <TrashIcon className="w-5 h-4/5 text-white" />
            </button>
          </div>
        </div>
      </div>
